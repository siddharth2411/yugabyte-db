...
class CatalogManager : public tserver::TabletPeerLookupIf,
 ...
 public:
  ...
  // Find all CDCSDK streams that contain the non eligible tables like indexes, mat views etc. in
  // their metadata.
  ...
  // This method compares all tables in the namespace eligible for a CDC stream to all the tables
